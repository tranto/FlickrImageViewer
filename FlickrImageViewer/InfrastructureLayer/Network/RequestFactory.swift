...
protocol RequestFactoryProtocol: class {
	 ...
	 func makeSearchPhotosRequestWith(location: Location, page: Int) throws -> URLComponents
	 func makeSearchPhotosRequestWith(tags: [String], location: Location) throws -> URLComponents
	 func makeSearchPhotosRequestWith(tags: [String], location: Location, page: Int) throws -> URLComponents
}
...
class RequestFactory: RequestFactoryProtocol {
	...
	public func makeSearchPhotosRequestWith(tags: [String], location: Location) throws -> URLComponents {
		return try self.makeSearchPhotosRequestWith(tags: tags, location: location, page: 1)
	}
	
	public func makeSearchPhotosRequestWith(location: Location, page: Int) throws -> URLComponents {
		return try self.makeSearchPhotosRequestWith(tags: [], location: location, page: page)
	}
	
	func makeSearchPhotosRequestWith(tags: [String], location: Location, page: Int) throws -> URLComponents {
		let tagsInStr = tags.joined(separator: ",")
		let payload = SearchPhotoPayload(perPage: nil, radiusUnits: "km", lat: String(format: "%f", location.lat), lon: String(format: "%f", location.lon), tags: tagsInStr, sort: nil, contentType: nil, tagMode: nil, page: page)
